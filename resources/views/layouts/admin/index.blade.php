...
<head>
    ...
    <title>ToXVic</title>
    <link rel="icon" href="{{asset('logo.png')}}" type="image/icon type" class="img-circle">
...
<div class="wrapper">
    ...
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color:#fe1d9f">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            <li class="nav-item">
